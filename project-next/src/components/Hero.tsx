    ...
    <section className="w-full bg-white dark:bg-gray-900 pt-20 pb-16 overflow-hidden">
      <div className="max-w-7xl mx-auto px-6 grid md:grid-cols-2 gap-12 items-center">
        ...
        >
          ...
          >
            <div className="flex flex-col items-center justify-center md:justify-start gap-2 md:flex-row">
              <div className="flex gap-2">
                <span className="text-xl">🇦🇪</span>
                <span className="text-xl">🇶🇦</span>
                <span className="text-xl">🇮🇳</span>
              </div>
              <span>Trusted by <b>Alharmain (Dubai)</b> and enterprises across Qatar & India</span>
            </div>
            <p className="text-blue-600 dark:text-blue-400 mt-1 font-medium">
              Elevating digital presence with 5+ years of intense expertise per expert.
            </p>
          </motion.div>
        </motion.div>
