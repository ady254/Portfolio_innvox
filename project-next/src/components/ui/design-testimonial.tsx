...
const testimonials = [
  {
    quote: "Innvox built a stunning website for our premium car care centre — complete with a 3D configurator and slide-to-book service flow.",
    author: "Sangat Motor Centre",
    role: "Automotive • Patna, Bihar",
    company: "Sangat Motor",
  },
  {
    quote: "InnVox built our website and managed our ads. We get 4x more leads than before.",
    author: "Al Harmain Islamic Institute",
    role: "Education",
    company: "Al Harmain",
  },
  {
    quote: "We are very satisfied with the e-commerce website delivered by Innvox. The design is clean, user-friendly, and all features work smoothly.",
    author: "Altamash Nasim",
  ...
  {
    quote: "We truly appreciate the teamwork and dedication of the Innvox team. Thank you for building our online platform.",
    author: "Kunal Dhingra",
    role: "Electroplating Industry",
    company: "Metal Works",
  },
]
              ...
              <div className="flex-1 md:pl-16 py-8 md:py-12">
                ...
                <div className="flex flex-col sm:flex-row items-start sm:items-end justify-between gap-6">
                  ...
                  <div className="flex items-center gap-4">
                    <motion.button
                      onClick={goPrev}
                      className="group relative w-12 h-12 rounded-full border border-border flex items-center justify-center overflow-hidden hover:border-blue-300 transition-colors"
                      whileTap={{ scale: 0.95 }}
                    >
                      <svg
                        width="18"
